                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="bg-white rounded-lg shadow-md p-6 text-center">
                            <div
                                className="w-16 h-16 bg-[#E8C07D] rounded-full mx-auto mb-4 flex items-center justify-center">
            ...
            <footer className="bg-[#333333] text-white py-8">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <div className="flex justify-center space-x-6 text-sm">
                        <a href="/about" className="hover:text-[#E8C07D] transition-colors">
                            About
                        </a>
                        <a href="/contact" className="hover:text-[#E8C07D] transition-colors">
                            Contact
                        </a>
                        <a href="/privacy" className="hover:text-[#E8C07D] transition-colors">
                            Privacy
                        </a>
                        <a href="/terms" className="hover:text-[#E8C07D] transition-colors">
                            Terms
                        </a>
                    </div>
                </div>
